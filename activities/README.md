...
- `Activities` 更关注团队如何与公众、同行和未来协作者发生连接
- `Performances` 更关注作品在具体场域中的呈现

## 推荐先做的一件事

如果你希望长期跟着我们的活动走，最直接的方式是先订阅：
...
它也是 VIRTURA 作为创作网络持续发声、持续交流、持续把作品和方法带回现实场景的一种方式。我们会在这些活动里分享正在进行的线索，也会把一部分资源、方法和讨论空间继续开放给真正感兴趣的人。

所以如果你只是想关注这个网络、来旁听、看看最近的方向，完全可以先从活动入口认识我们，而不必先决定是否合作。

## 当前公开活动入口

- [VIRTURA 官方活动日历](https://lu.ma/VIRTURA)：当前最适合长期关注和订阅的入口
- [VIRTURA-SpacePort / stations](https://github.com/ewanqian/VIRTURA-SpacePort/tree/main/stations)：更完整的活动站点入口、系列时间线与活动日历说明
...
- `2026-04-10` `Concept Brief 01｜数字情感容器不是抽象口号，它是怎么长出来的`
- `2026-04-11` `VIRTURA 空间茶话会 Vol.4｜一次线下现场，怎样变成可回看的数字档案`
- `2026-04-17` `Release 01｜Drop Flow 版本观看室开放`
- `2026-04-18` `太空气球 Session 02｜一段音乐，三种视觉：实时实验夜`
...
| 日期 | 活动 | 形式 | 角色 |
|---|---|---|---|
| 2026.03.21 | [太空气球线上演出空间 Alpha 测试](https://luma.com/go6kxnnw) | 线上演出空间测试 / 公开申请中 | 相关活动线 |
...
接下来这段时间，我们更倾向于把活动做成一条有坡度的时间线，而不是一组彼此无关的零散节点。
...
- 先旁听一次公开活动或线上分享
- 再对某个系列、某个研究方向或某个小模块产生兴趣
- 最后根据节奏，决定是继续关注、参与一次具体协作，还是长期保持联系
...
如果你还不确定自己适合哪种方式，最简单的做法是先从一场活动或一条研究线开始。
